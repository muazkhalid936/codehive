...
export const industries = [
      ...
      cards: [
        {
          ...
          description:
            'Streamline the process of booking appointments with a user-friendly system that minimizes time and effort.',
          image: '/feature/calender.png',
          talkAnExpert: true,
          path: '/service/software-development',
        },
        {
          ...
          description:
            'Facilitate secure and hassle-free payment options, ensuring a seamless transaction experience for users.',
          image: '/feature/mobilecard.png',
          talkAnExpert: true,
          path: '/service/mobile-app-development',
        },
        {
          ...
          description:
            'Organize customer details, preferences, and service history to enhance personalized engagement and efficiency.',
          image: '/feature/a.png',
          talkAnExpert: true,
          path: '/service/digital-transformation',
        },
        {
          ...
          description:
            'Run targeted promotional campaigns to attract new clients and retain existing ones, boosting overall business growth.',
          image: '/feature/annouce.png',
          talkAnExpert: true,
          path: '/service/digital-consultation',
        },
        {
          ...
          description:
            'Ensure smooth system performance with reliable technical support and regular updates.',
          image: '/feature/setting.png',
          talkAnExpert: true,
          path: '/service/website-development',
        },
        {
          ...
          description:
            'Sync bookings with personal or business calendars, enabling automated reminders and reducing missed appointments.',
          image: '/feature/alert.png',
          talkAnExpert: true,
          path: '/service/business-intelligence',
        },
        {
          ...
          description:
            'Empower users and staff to access, book, and manage appointments on the go with a fully mobile-compatible platform.',
        ...
        },
        {
          ...
          description:
            'Efficiently manage bookings and resources across multiple branches or service locations in a centralized system.',
          image: '/feature/gps.png',
          talkAnExpert: true,
          path: '/service/business-intelligence',
        },
      ],
      ...
      cards: [
        {
          name: 'Salon',
          description:
            'Simplify appointments for haircuts, styling, and beauty services.',
          picture: '/IndustriesBooking/Slider1.jpeg',
        },
        {
          name: 'Restaurant',
        ...
        },
        {
          ...
          description:
            'Manage room bookings and event reservations effortlessly.',
          picture: '/IndustriesBooking/Slider3.png',
        },
        {
          name: 'Fitness Center',
          description:
            'Allow members to book classes and equipment conveniently.',
          picture: '/IndustriesBooking/Slider4.png',
        },
        {
          name: 'Clinics',
          description:
            'Enable easy patient scheduling and doctor availability tracking.',
          picture: '/IndustriesBooking/Slider5.png',
        },
        {
          name: 'Auto Workshop',
        ...
        },
        {
          name: 'Spa',
          description:
            'Schedule wellness services and manage therapist availability.',
          picture: '/IndustriesBooking/Slider7.png',
        },
        {
          name: 'Rent a Car',
        ...
        features: [
          {
            ...
            description:
              'Craft a dynamic and engaging interface to captivate your customers.',
          },
          {
            icon: '/E-commerce/8.png',
            title: 'Shopping Cart',
            description:
              'Streamline the shopping process with a user-centric and efficient cart system.',
          },
          {
            icon: '/E-commerce/9.png',
            title: 'Rating and Reviews',
            description:
              'Gather valuable feedback and build trust with a robust rating and review feature.',
          },
          {
            icon: '/E-commerce/10.png',
            title: 'Promo Code',
            description:
              'Boost sales and customer loyalty with promotional code capabilities.',
          },
          {
            icon: '/E-commerce/11.png',
            title: 'Wishlist',
            description:
              'Enable customers to save their favorite products for future purchases effortlessly.',
          },
          {
            icon: '/E-commerce/12.png',
            title: 'Filter Option',
            description:
              'Enhance product discoverability with advanced filtering options.',
          },
        ],
      ...
      cards: [
        {
          ...
          image: '/feature/easy.png',
          talkAnExpert: true,
          path: '/service/software-development',
        },
        {
          title: 'Secure Payment Integeration',
          description:
  ...
  },
  {
    ...
    panelData: [
        ...
        features: [
          {
            ...
            description:
              'Enable users to create accounts, personalize profiles with their details, and specify fitness goals and preferences.',
          },
          {
            icon: '/FitnessApp/2.png',
            title: 'Workout Plans',
            description:
              'Provide diverse workout routines tailored to various fitness levels and objectives, including cardio, strength training, and flexibility exercises.',
          },
          {
            icon: '/FitnessApp/3.png',
            title: 'Exercise Demonstrations',
            description:
              'Incorporate detailed video tutorials and descriptions to guide users in performing exercises correctly and safely.',
          },
          {
            icon: '/FitnessApp/4.png',
            title: 'Progress Tracking',
            description:
              'Help users monitor their fitness journey by recording workouts, tracking weight and measurements, and visualizing progress over time.',
          },
          {
            icon: '/FitnessApp/5.png',
            title: 'Nutrition Tracking',
            description:
              'Allow users to log meals, monitor calorie consumption, and access personalized nutrition suggestions to support their goals.',
          },
          {
            icon: '/FitnessApp/6.png',
            title: 'Social Features',
            description:
              'Foster community by enabling users to connect with friends, participate in fitness groups, and share milestones and progress.',
          },
          {
            icon: '/FitnessApp/7.png',
            title: 'In-App Purchases',
            description:
              'Monetize with premium features, exclusive content, or personalized coaching plans available through in-app purchases.',
          },
        ],
      ...
      },
      {
        ...
        heading: 'Gym App',
        description:
          'Effortlessly manage and optimize your gym operations with our powerful admin panel.',
        features: [
          {
      ...
      },
      {
        ...
        heading: 'Trainer App',
        description:
          'Empower your trainers and gym with our personal trainer app development solutions, streamlining appointment scheduling and client management.',
        features: [
          {
            icon: '/FitnessApp/12.png',
            title: 'Profile Management',
            description:
              'Get a comprehensive profile management solution for trainers. Let them easily create and manage profiles, showcasing their expertise and services.',
          },
          {
            icon: '/FitnessApp/13.png',
            title: 'Appointment Scheduling',
            description:
              'Streamline appointment scheduling for trainers. Let them have an overview of their scheduled training sessions and manage their schedules.',
          },
          {
            icon: '/FitnessApp/14.png',
            title: 'Client Management',
            description:
              'Manage clients efficiently with our client management tools. Keep track of client information, progress, and communication history to provide a personalized training experience.',
          },
          {
            icon: '/FitnessApp/15.png',
            title: 'Payment Tracking',
            description:
              'Simplify payment tracking, providing trainers and gym owners with insights into their earnings, and staying on top of financials effortlessly.',
          },
        ],
      ...
      },
      {
        ...
        heading: 'Admin Panel',
        description:
          'Oversee and optimize your fitness business operations with our comprehensive and powerful admin panel.',
        features: [
          {
    ...
    bannerDataTwo: {
      ...
      title:
        'Shape the future of fitness with Code Hive—bring your vision to life!',
  ...
  },
  {
    ...
    panelData: [
      {
        ...
        description:
          'App used at the customer end to place an order and get it delivered. Users can order, track, and make payment from this app:',
        features: [
          {
            icon: '/DeliveryApp/1.png',
            title: 'User Registration',
            description:
              'Enable users to create accounts, personalize profiles with their details, and specify preferences.',
          },
          {
            icon: '/DeliveryApp/2.png',
            title: 'Various Payment Options',
            description:
              'Offer diverse payment methods to ensure flexibility and convenience for users.',
          },
          {
            icon: '/DeliveryApp/3.png',
            title: 'Order Services',
            description:
              'Easily place orders with detailed video tutorials or descriptions for assistance.',
          },
          {
            icon: '/DeliveryApp/4.png',
            title: 'Offers & Discounts',
            description:
              'Enable customers to avail themselves of discounts and promotional offers seamlessly.',
          },
          {
            icon: '/DeliveryApp/5.png',
            title: 'Order Tracking',
            description:
              'Provide real-time tracking of placed orders for better customer experience.',
          },
        ],
      ...
      },
      {
        ...
        heading: 'Admin Panel',
        description:
          'Effortlessly oversee and optimize delivery business operations with our comprehensive and powerful admin panel:',
        features: [
          {
            icon: '/DeliveryApp/6.png',
            title: 'Service Tracking',
            description:
              'Monitor delivery processes and ensure timely service execution.',
          },
          {
            icon: '/DeliveryApp/7.png',
            title: 'Manage Customers',
            description:
              'Manage customer data and ensure proper access to services and resources.',
          },
          {
            icon: '/DeliveryApp/8.png',
            title: 'Manage Payments',
            description:
              'Oversee transactions, manage revenue streams, and generate detailed financial reports.',
          },
          {
            icon: '/DeliveryApp/9.png',
            title: 'Delivery Agents',
            description:
              'Effectively assign delivery tasks to agents and resolve customer inquiries.',
          },
          {
            icon: '/DeliveryApp/10.png',
            title: 'Analytics & Insights',
            description:
              'Gain insights into service efficiency, delivery performance, and user engagement.',
          },
        ],
      ...
      },
      {
        ...
        heading: 'Driver App',
        description:
          'The Driver App is designed to assist delivery agents with managing their tasks and optimizing delivery routes:',
        features: [
          {
            icon: '/DeliveryApp/11.png',
            title: 'Manage Profile',
            description:
              'Allow delivery agents to manage their profiles and monitor tasks efficiently.',
          },
          {
            icon: '/DeliveryApp/12.png',
            title: 'In-App Chat',
            description:
              'Enable seamless communication with customers for delivery updates or clarifications.',
          },
          {
            icon: '/DeliveryApp/13.png',
            title: 'Reminder & Alerts',
            description:
              'Notify agents about upcoming deliveries, important updates, or schedule changes.',
          },
          {
            icon: '/DeliveryApp/14.png',
            title: 'Electronic Proof of Delivery',
            description:
              'Record proof of delivery digitally for smooth order completion.',
          },
          {
            icon: '/DeliveryApp/15.png',
            title: 'In-App Navigation',
            description:
              'Provide optimized routes and real-time navigation to delivery locations.',
          },
        ],
    ...
    featuresData: {
      ...
      subheading:
        'Ready to Elevate Your Delivery Service? Let’s Build Your App!',
      columns: 4,
      cards: [
        {
  ...
  },
  {
    ...
    panelData: [
        ...
        features: [
          {
            ...
            description:
              'Allow customers to choose and customize car wash packages according to their preferences and vehicle needs.',
          },
          {
            icon: '/CarwashApp/2.png',
            title: 'Service Logging',
            description:
              'Provide a platform for customers to log and track completed car wash services, including details like type and date of service.',
          },
          {
            icon: '/CarwashApp/3.png',
            title: 'Appointment Scheduling',
            description:
              'Display service schedules and let users book appointments directly through the app or at the car wash location.',
          },
          {
            icon: '/CarwashApp/4.png',
            title: 'Facility Information',
            description:
              'Share detailed information about the car wash facilities, available services, pricing, and operating hours.',
          },
          {
            icon: '/CarwashApp/5.png',
            title: 'Multi-Vehicle Management',
            description:
              'Allow users to manage multiple vehicles under one account for added convenience.',
          },
          {
            icon: '/CarwashApp/6.png',
            title: 'Service History Records',
            description:
              'Provide a detailed log of past car wash services, including dates, services availed, and costs.',
          },
          {
            icon: '/CarwashApp/7.png',
            title: 'Feedback and Reviews',
            description:
              'Enable customers to leave reviews and ratings for the service to enhance quality and customer satisfaction.',
          },
        ],
      ...
      },
      {
        ...
        description:
          'Streamline car wash operations with a powerful app to manage bookings, track services, and deliver a seamless customer experience:',
        features: [
          {
            icon: '/CarwashApp/8.png',
            title: 'Booking Management',
            description:
              'View and manage assigned bookings, including customer details, service type, and schedule.',
          },
          {
            icon: '/CarwashApp/9.png',
            title: 'Service Status Updates',
            description:
              "Update the status of each service in real-time, from 'In Progress' to 'Completed.'",
          },
          {
            icon: '/CarwashApp/10.png',
            title: 'Task Scheduling',
            description:
              'Manage daily schedules, view upcoming tasks, and get reminders for assigned services.',
          },
          {
            icon: '/CarwashApp/11.png',
            title: 'Vehicle Details',
            description:
              'Access information about the vehicle, such as make, model, and special instructions, for a personalized service.',
          },
          {
            icon: '/CarwashApp/12.png',
            title: 'Service History',
            description:
              'View a record of completed services, including customer details and earnings.',
          },
          {
            icon: '/CarwashApp/13.png',
            title: 'Availability Settings',
            description:
              'Set availability for accepting new bookings and manage working hours with ease.',
          },
          {
            icon: '/CarwashApp/14.png',
            title: 'Notifications and Alerts',
            description:
              'Receive real-time notifications for new bookings, schedule changes, or urgent tasks.',
          },
        ],
      ...
      },
      {
        ...
        heading: 'Admin Panel',
        description:
          'Simplify and enhance your car wash business operations with our robust and user-friendly admin panel:',
        features: [
          {
          ...
          },
          {
            ...
            description:
              'Easily update service offerings, manage service packages, and adjust pricing as needed.',
          },
          {
            icon: '/CarwashApp/17.png',
            title: 'Booking Management',
            description:
              'Manage and oversee customer bookings, monitor bay reservations, and address scheduling conflicts in real-time.',
          },
          {
            icon: '/CarwashApp/18.png',
            title: 'Analytics and Insights',
            description:
              'Access detailed analytics on app usage, customer bookings, and revenue trends to make informed decisions.',
          },
          {
            icon: '/CarwashApp/19.png',
            title: 'Real-Time Notifications',
            description:
              'Receive instant alerts for new bookings, payment confirmations, or issues that require attention.',
          },
          {
            icon: '/CarwashApp/20.png',
            title: 'Staff Management',
            description:
              'Assign and track tasks for service providers, manage work schedules, and monitor performance.',
          },
        ],
      ...
      },
      {
        ...
        description:
          'Gain full control over your car wash business with advanced features and centralized management tools:',
        features: [
          {
            icon: '/CarwashApp/21.png',
            title: 'Centralized Dashboard',
            description:
              'Gain a comprehensive view of all car wash locations, bookings, revenue, and overall performance metrics in one place.',
          },
          {
            icon: '/CarwashApp/22.png',
            title: 'User and Role Management',
            description:
              'Control access and permissions for admins, staff, service providers, and customers across all locations.',
          },
          {
            icon: '/CarwashApp/23.png',
            title: 'Booking Oversight',
            description:
              'Oversee and manage bookings across locations, resolve conflicts, and reassign tasks as needed.',
          },
          {
            icon: '/CarwashApp/24.png',
            title: 'Marketing and Promotions',
            description:
              'Plan and execute marketing campaigns, such as discounts, seasonal offers, and loyalty programs, across all locations.',
          },
          {
            icon: '/CarwashApp/25.png',
            title: 'Inventory Control',
            description:
              'Monitor inventory levels across all locations, approve restocking requests, and set minimum stock thresholds.',
          },
          {
            icon: '/CarwashApp/26.png',
            title: 'Customizable Service Packages',
            description:
              'Define and adjust service offerings, pricing, and add-ons for different locations to cater to diverse customer needs.',
          },
          {
            icon: '/CarwashApp/27.png',
            title: 'Subscription and Membership Management',
            description:
              'Oversee customer memberships, subscription plans, and loyalty rewards across all locations.',
          },
          {
            icon: '/CarwashApp/28.png',
            title: 'Compliance and Reporting',
            description:
              'Ensure regulatory compliance by maintaining records and generating reports for audits and inspections.',
          },
        ],
    ...
    featuresData: {
      ...
      description:
        'As a top Pickup and Delivery app development company, we drive transformative digital solutions that elevate industry standards.',
      subheading:
        'Transform Your Car Wash Business Today Contact Us for Expert Solutions!',
      columns: 4,
      cards: [
        {
