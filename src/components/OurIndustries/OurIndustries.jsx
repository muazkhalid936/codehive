...
export const ourIndustriesData = [
  ...
  // },
  {
    ...
    ades2: "يمكنك بسهولة إدارة المنتجات، تتبع المخزون في الوقت الفعلي، وزيادة المبيعات من خلال التوصيات المخصصة. تضمن عمليات الدفع الآمنة وخطوات الشراء المبسطة تجربة تسوق مريحة للعملاء.",
  ...
  },
  {
    ...
    ades2: "وفّر للمستخدمين خطط تمارين مخصصة، تتبع التقدم، وعروض تمارين إرشادية للحفاظ على تفاعلهم وتحفيزهم.",
