        ...
        <div className="flex flex-wrap  justify-start items-center">
          {data.cards.map((item, index) => {
            ...
            const cardClasses = `
              ...
              mx-5 my-5 p-6 h-[250px] flex cursor-pointer flex-col justify-center items-center   
            ...
            return (
              <div
                key={index}
                className={`w-[95%] ${data.columns === 4 ? "md:w-1/4" : "md:w-1/3"
                  }`}
              >
                <div
                ...
                >
                  {/* Image Container */}
                  <div
                    className={`transition-opacity duration-500 ${itemHovered === item.title ? "opacity-0" : "opacity-100"
                      }`}
                  >
                    <img
                      src={item.image}
                    ...
                    />
                    <h2 className="text-center text-xl mb-2">{item.title}</h2>
                  </div>
                  ...
                  >
                    ...
                    {item.talkAnExpert && (
                      ...
                      >
                        ...
                        <div className="p-2 rounded-full absolute right-2 bg-white">
