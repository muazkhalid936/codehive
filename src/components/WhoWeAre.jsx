...
const WhoWeAre = () => {
  return (
    <div className="container py-[55px] rounded-lg">
      <div className="bg-[url('/whoweare/bgImage.png')] bg-cover  bg-center h-[50vh] w-full rounded-[20px] items-center md:items-center justify-start sm:justify-center flex md:justify-around  sm:gap-32 gap:4 px-6 sm:px-0">
