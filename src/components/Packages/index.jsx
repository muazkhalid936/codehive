...
const index = () => {
  ...
  const features = [
    ...
    { name: "Customizable notifications", available: false },
    { name: "Analytics Dashboard", available: true },
    { name: "Multi-language support", available: false },
    { name: "Third-party integrations", available: true },
    { name: "Data export and import", available: false },
    { name: "Role-based access control", available: true },
    { name: "Custom branding", available: false },
    { name: "Dark mode", available: true },
    { name: "Push notifications", available: false },
    { name: "AI-based recommendations", available: false },
