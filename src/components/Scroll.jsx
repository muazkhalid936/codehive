...
import Card from "./OurRecentWorks/Card";
...
//   }, []);
  ...
  useEffect(() => {
    ...
    gsap.fromTo(
      cards,
      {
        x: (index) => (language === "en" ? -index * 300 : index * 300), // Adjust the 300 value based on your card width
      },
      {
        x: (index) => (language === "en" ? index * 300 : -index * 300),
        ease: "none",
        scrollTrigger: {
